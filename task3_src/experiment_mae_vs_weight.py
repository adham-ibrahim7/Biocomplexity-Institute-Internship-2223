...
if __name__ == "__main__":
    ...
    out_filename = "../task3_data/experiment_mae_vs_weight.csv"
    #
    ...
    for horizon_index in range(20, 30):
        ...
        for lead_time in [12]:
            ...
            for county in counties:
                for step_ahead in ['1-step_ahead']:
                    ...
                    # print(forecast.get_mae())
                    # print(forecast.get_weights())

                    best_method = min(training_methods, key=forecast.get_mae().get)

                    all_weights = forecast.get_weights()
                    weight = all_weights[best_method]
                    sorted_values = sorted(all_weights.values(), reverse=True)
                    rank = sorted_values.index(weight) + 1
